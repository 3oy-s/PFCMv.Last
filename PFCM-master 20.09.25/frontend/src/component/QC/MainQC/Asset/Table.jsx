...
const Row = ({
  ...
  const { rmfp_id, dest, stay_place, CookedDateTime, oven_to_cold, rm_type_id, mapping_id, rm_status, ...displayRow } = row;
        ...
        <TableCell
          ...
          {(() => {
            ...
            if ((dest === "เข้าห้องเย็น" || dest === "ไปบรรจุ" || dest === "ผสมเตรียม" ) && rm_status === "รอQCตรวจสอบ") {
              ...
              return "รออบเสร็จ";
            } else if (dest === "เข้าห้องเย็น" && (rm_status === "รอกลับมาเตรียม" || rm_status === "รอ Qc")) {
              return "รอQC ตรวจสอบ";
            } else {
              return "-";
            }
