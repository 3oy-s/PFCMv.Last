...
const ModalPrintDetail = ({ open, onClose, data, onEdit, dataForModal3 }) => {
                    ...
                    <Box sx={{
                        ...
                        >
                            ...
                            <Box
                                ...
                                สถานที่จัดส่ง : {dest === 'เข้าห้องเย็น' ? 'เข้าห้องเย็น' : dest === 'ไปบรรจุ' ? rmm_line_name : (dest || "ไม่มีข้อมูล")}
                            </Box>
                        </Box>
                        ...
                        <Typography variant="h6" className="print-text" sx={{
                            ...
                            {dest === 'เข้าห้องเย็น' && (
                                <span style={{ marginLeft: "20px" }}>สถานที่บรรจุ : {rmm_line_name || "ไม่มีข้อมูล"}</span>
                            )}
                        </Typography>
...
export default ModalPrintDetail;