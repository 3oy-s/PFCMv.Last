...
const ParentComponent = () => {
  ...
  // ย้าย fetchData ออกมาข้างนอก
  const fetchData = async () => {
    try {
      const response = await axios.get(`${API_URL}/api/prep/getRMForProdMixToPackList`, { withCredentials: true });
  ...
  // เรียก fetchData ครั้งแรกเมื่อ component mount
  useEffect(() => {
    fetchData();
  }, []);
