...
const Row = ({
  ...
  //ซ่อนคอลัม
  const { rmfp_id, oven_to_pack, dest, raw_or_cooked, rmforinclude_id, sap_re_id, cooked_group, prep_to_cold, rm_type_id, cold, ...displayRow } = row;
...
const TableMainPrep = ({ handleOpenModal, data, handleRowClick, handleOpenEditModal,handleOpenModal4, handleOpenSuccess, handleOpenDeleteModal }) => {
  ...
  //
  const columns = Object.keys(data[0] || {}).filter(key => key !== 'rmforinclude_id' && key !== 'oven_to_pack');
          ...
          <TableHead style={{ marginBottom: "10px" }}>
            <TableRow sx={{ height: '40px' }}>
              ...
              {/* เปลี่ยนชื่อคอลัมน์ที่นี่ */}
                ...
                <Box style={{ fontSize: '16px', color: '#ffffff' }}>mixtp_id</Box> {/* mat_name */}
              </TableCell>
              ...
              <TableCell align="center" style={{ backgroundColor: "hsl(210, 100%, 60%)", borderTop: "1px solid #e0e0e0", borderBottom: "1px solid #e0e0e0", borderRight: "1px solid #f2f2f2", fontSize: '12px', color: '#787878', padding: '5px', width: "200px" }}>
                <Box style={{ fontSize: '16px', color: '#ffffff' }}>แผนการผลิต</Box> {/* mat_name */}
              </TableCell>
              <TableCell align="center" style={{ backgroundColor: "hsl(210, 100%, 60%)", borderTop: "1px solid #e0e0e0", borderBottom: "1px solid #e0e0e0", borderRight: "1px solid #f2f2f2", fontSize: '12px', color: '#787878', padding: '5px', width: "200px" }}>
                <Box style={{ fontSize: '16px', color: '#ffffff' }}>สถานะวัตถุดิบ</Box> {/* mat_name */}
              </TableCell>
              <TableCell align="center" style={{ backgroundColor: "hsl(210, 100%, 60%)", borderTop: "1px solid #e0e0e0", borderBottom: "1px solid #e0e0e0", borderRight: "1px solid #f2f2f2", fontSize: '12px', color: '#787878', padding: '5px', width: "200px" }}>
                <Box style={{ fontSize: '16px', color: '#ffffff' }}>เวลา QC ตรวจสอบ</Box> {/* mat_name */}
              </TableCell>
              <TableCell align="center" style={{ backgroundColor: "hsl(210, 100%, 60%)", borderTop: "1px solid #e0e0e0", borderBottom: "1px solid #e0e0e0", borderRight: "1px solid #f2f2f2", fontSize: '12px', color: '#787878', padding: '5px', width: "200px" }}>
                <Box style={{ fontSize: '16px', color: '#ffffff' }}>วันที่เบิก</Box> {/* mat_name */}
              </TableCell>
